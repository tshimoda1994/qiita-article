...
tags:
  ...
  - CloudWatch
private: false
updated_at: '2026-05-07T21:34:34+09:00'
...
従来はOSへのセットアップやAWS Systems Managerを使った設定が中心でしたが、今回の更新でEC2 コンソールからでも CloudWatch Agent の導入・設定まで進められるようになりました。
利用機会が多いだけに、画面操作で完結できる手順は運用の負荷を下げられるのではないかと考え、その検証内容を記事にまとめました。
